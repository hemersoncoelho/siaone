    ...
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-[420px] bg-[#141415] border-l border-[#27272A] z-50 flex flex-col shadow-2xl overflow-hidden animate-in slide-in-from-right duration-300">
        ...
        <div className="flex items-start justify-between gap-4 p-5 border-b border-[#27272A] shrink-0">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-lg hover:bg-white/10 text-stone-500 hover:text-white transition-colors shrink-0 mt-0.5"
          >
            <X size={16} />
          </button>
        </div>
        ...
        {/* ── Scrollable content ── */}
        <div
          className="flex-1 overflow-y-auto divide-y divide-[#27272A]"
                ...
                <div className="relative" ref={moveMenuRef}>
                  <button
                    ...
                    className={cn(
                      ...
                      'px-3 py-1.5 rounded-lg border border-[#27272A] bg-white/5 hover:bg-white/10',
                  ...
                  {showMoveMenu && (
                    <div className="absolute right-0 top-9 z-50 min-w-[180px] bg-[#1C1C1E] border border-[#3A3A3C] rounded-lg shadow-2xl overflow-hidden">
          ...
          {deal.contact && (
            <div className="p-5">
              ...
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-white/[0.08] border border-[#27272A] flex items-center justify-center text-xs font-semibold text-stone-300 uppercase shrink-0">
          ...
          {deal.conversation && (
            <div className="p-5">
              ...
              <button
                ...
                className="w-full flex items-center justify-between gap-3 p-3 bg-white/[0.04] hover:bg-white/[0.08] border border-[#27272A] hover:border-stone-600 rounded-lg transition-all group"
              >
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-white/[0.06] border border-[#27272A] flex items-center justify-center shrink-0">
          ...
          {deal.assigned_user && (
            <div className="p-5">
              ...
              <div className="flex items-center gap-2.5">
                <div className="w-7 h-7 rounded-full bg-white/[0.08] border border-[#27272A] flex items-center justify-center text-[10px] font-semibold text-stone-300 uppercase shrink-0">
          ...
          <div className="p-5">
            ...
            <div className="relative space-y-4 pl-4">
              ...
              <div className="relative flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs font-medium text-stone-300">Deal criado</p>
              ...
              {deal.updated_at && deal.updated_at !== deal.created_at && (
                <div className="relative flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs font-medium text-stone-300">Última atualização</p>
                    <div className="flex items-center gap-1.5 mt-1 text-[11px] text-stone-600">
                      <Clock size={10} />
              ...
              {currentStage && (
                <div className="relative flex items-start gap-3">
                  ...
                  />
                  <div>
                    <p className="text-xs font-medium text-stone-300">Estágio atual</p>
